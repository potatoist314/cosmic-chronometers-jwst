...
| `spectral fitting/Age-dating Early Quiescent Galaxies - High Star-formation Efficiency, but Consistent with Direct, Higher-redshift Observations.pdf` | Turner et al. (2025), MNRAS 537:1826–1848, arXiv:2410.05377 | Defines a rising continuity SFH prior in Prospector (§3.3, Eq. 4): SFR-ratio means follow halo accretion; tested on ZF-UDS-7329 at z = 3.2 |
...
| `quiescent populations/Elemental Abundances and Ages of z 0.7 Quiescent Galaxies on the Mass-Size Plane.pdf` | Beverage et al. (2021), ApJL 917:L1, arXiv:2105.12750 | 65 LEGA-C quiescent galaxies with alf; [Fe/H] and [Mg/H] follow M*/Re, [Mg/Fe] flat |
| `quiescent populations/From Carbon to Cobalt - Chemical Compositions and Ages of z 0.7 Quiescent Galaxies.pdf` | Beverage et al. (2023), ApJ 948:140, arXiv:2303.03412 | 135 LEGA-C quiescent galaxies stacked in velocity dispersion; 11 element abundances against z~0 |
| `quiescent populations/The Elemental Abundances of Quiescent Galaxies in the LEGA-C Survey - The (Non-)Evolution of Alpha-Fe from z 0.75 to z 0.pdf` | Bevacqua et al. (2023), MNRAS 525:4219, arXiv:2308.03441 | 183 LEGA-C quiescent galaxies; mean [alpha/Fe] +0.24 from Mgb and Fe4383, no evolution to z=0 |
| `quiescent populations/A New Perspective on the Stellar Mass-Metallicity Relation of Quiescent Galaxies from the LEGA-C Survey.pdf` | Bevacqua et al. (2024), A&amp;A, arXiv:2407.12704 (volume not recorded) | 637 LEGA-C quiescent galaxies; mass-weighted metallicity with a mass-dependent lower bound |
| `quiescent populations/LEGA-C Stellar Populations Scaling Relations I - Chemo-archaeological Downsizing Trends at z 0.7.pdf` | Gallazzi et al. (2026a), A&amp;A, arXiv:2512.07952 (volume not recorded) | 552 LEGA-C galaxies; light-weighted age and metallicity against mass and velocity dispersion |
| `quiescent populations/LEGA-C Stellar Populations Scaling Relations II - Mass-complete Archaeological Trends and Their Evolution since z 0.7.pdf` | Gallazzi et al. (2026b), A&amp;A 708:A290, arXiv:2511.11805 | Quiescent and star-forming trends at z~0.7 against aperture-corrected SDSS DR7 |
| `quiescent populations/Ages and Metallicities of Quiescent Galaxies - Confronting UVJ Colours with Stellar Absorption Lines.pdf` | Cheng et al. (2025), MNRAS 540:1527, arXiv:2505.08858 | ~700 LEGA-C quiescent galaxies with alf; age and [Fe/H] across the UVJ diagram, M/L tension |
| `quiescent populations/Early-Type Galaxy Archeology - Ages, Abundance Ratios, and Effective Temperatures from Full-Spectrum Fitting.pdf` | Conroy, Graves &amp; van Dokkum (2014), ApJ 780:33, arXiv:1303.6629 | z~0 anchor: SDSS early-type stacks, [Fe/H], [Mg/Fe] and age against velocity dispersion |

The "role" column records why each paper is here, not an agreed plan to use it.

See the [concise stellar-population fitting review](spectral%20fitting/README.md) and the
[quiescent-galaxy stellar-population review](quiescent%20populations/README.md).
