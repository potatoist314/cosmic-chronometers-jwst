...
- `guides/vast-ai-gpu-workflow.html` — Explains single- and four-GPU Vast setup, production sampling, and saved results.
...
- `analyses/ceridwen-gpu-benchmarks.html` — Compares measured speed, cost, memory, and hardware behaviour across eight GPU types.
