...
<details class="model-row"><summary><span class="model-s">SFH nodes</span><span class="model-v">0, 0.03, 0.1, 0.3, 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 5 Gyr and the age of the Universe at z; step interpolation</span><span class="model-w"></span><span class="model-f"></span></summary><ul><li><i>note</i> 0.5 Gyr spacing from 1 to 5 Gyr since 24 Sep 2026; 1, 3, 5 Gyr before</li></ul></details>
<details class="model-row"><summary><span class="model-s">SFH prior</span><span class="model-v">Student-t(0, 0.3 dex, df 2) on 13 log ratios</span><span class="model-w">Liu Hao, 6 Sep 2026</span><span class="model-f"></span></summary><ul><li><i>tested</i> Uniform(−3, 3): Student-t raises age in 5 of 6, widens every interval, \(\ln Z\) falls 0.7–6.8 · <a href="/wiki/e/e-sfh-prior/">sfh_cont</a></li><li><i>note</i> rising continuity prior raised by Jonah Powley · <a href="/wiki/n/meeting-2026-09-17-jonah-powley/">17 Sep 2026 meeting</a></li><li><i>papers</i> continuity, rising and other variants · <a href="/wiki/n/sfh-continuity-prior-variants/">SFH continuity prior and its variants</a></li><li><i>note</i> 13 ratios since 24 Sep 2026, 7 before</li></ul></details>
...
<dl class="model-group">
<div class="model-row"><span class="model-s">Bin masses</span><span class="model-v">Trapezoidal integral of the SFR over each of the 13 intervals</span><span class="model-w"></span><span class="model-f"></span></div>
