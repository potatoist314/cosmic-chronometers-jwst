...
| Target | z | Fitted pixels | Median pixel \(\mathrm{S/N}\) | Photometry sum \((\mathrm{S/N})^2\) | Spectrum / photometry, raw | Spectrum / photometry, \(f_{\mathrm{calib}}\) = 3% | Feature pixels | Balance factor |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
Feature selection removes 56 to 71 percent of the pixels. The summed \((\mathrm{S/N})^2\) ratio between spectrum and photometry remains between 80 and 3,000.

A sum of \((\mathrm{S/N})^2\) only measures amplitude information. The Fisher matrix of the notebook model at the mock truth (Jacobians of the predicted photometry and spectrum, the notebook noise model with \(f_{\mathrm{calib}}\) = 2.9 percent, and the prior curvature added as a diagonal) splits the information per parameter and forecasts the marginal posterior width of a photometry-only, spectrum-only, and joint fit in every pixel mode. For M5_172669:
...
Photometry contributes below one percent of the diagonal Fisher information for each tabulated parameter, with or without the feature mask. The forecast mass width is 0.105 dex for spectrum-only and 0.012 dex for photometry-only. Feature selection increases forecast widths for metallicity, \([\alpha/\mathrm{Fe}]\) and dust by factors of 1.3 to 1.5. SFH ratios are omitted from the table.

Source: `scripts/absorption_mask_analysis.py budget --features` and `fisher`; catalogue \(\mathrm{S/N}\) percentiles of the 187-object passive sample are 8, 13, 22, 31 and 39 at the 10th to 90th percentile.
...
Every fit is the production notebook run through the DR2 shard-runner worker (`scripts/absorption_mask_grid.py`): BlackJAX NSS with 500 live points, 65 inner steps, 100 deletions, logZ tolerance −5, the schema-2.1 C3K alpha-enhanced grid, seven-bin step SFH, constant metallicity, \([\alpha/\mathrm{Fe}]\), diffuse dust with fixed slope, fixed redshift and dispersion, fitted `log_f_calib` and `spectrum_scaling`. One comparison group is one target or one mock realisation fitted in all three pixel modes on the same GPU boot.

- Mocks: the truth is the weighted posterior median of the stored full-spectrum fit of M5_172669 (`results/absorption-mask/truth_M5_172669.json`). The mock keeps the real pixel grid, per-pixel errors, masks and filters; the spectrum is the model prediction times a linear continuum tilt from 1 − \(\epsilon\) to 1 + \(\epsilon\) across the fitted range plus Gaussian noise; the photometry is the prediction plus Gaussian noise. \(\epsilon\) ∈ {0, 0.03, 0.06}; per-pixel errors \(\times\) {1, 4} (\(\mathrm{S/N}\) \(\approx\) 106 and 26); two noise realisations each; 36 fits.
...
All 45 fits passed the DR2 diagnostics (45/45 finite evidence and ESS ≥ 200; lowest ESS 2970). Median sampler wall time: 214 s full spectrum, 193 s features only, 186 s down-weighted. Total Vast.ai spend for the job, including failed launches and the notebook re-run, was $2.24. One mock cell (tilt 0.03, \(\mathrm{S/N}\) 0.25, seed 1, down-weighted) needed two extra single-cell re-runs: its first executed notebook was truncated by a GPU out-of-memory error after the fit, and the second attempt died in a CUDA illegal-address fault; the third attempt is the one recorded.

</details>

| cell | mode | pixels | ESS | calls | sampler wall [s] | \(\ln Z\) | spec \(\chi^2\)/pixel | phot \(\chi^2\)/band |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| mock_tilt0.00_snr0.25_seed1_all | all | 3602 | 3085 | 1,072,500 | 232 | 231918.0 \(\pm\) 0.19 | 0.91 | 1.12 |
| mock_tilt0.00_snr0.25_seed1_features | features | 1389 | 3064 | 1,020,500 | 193 | 89702.3 \(\pm\) 0.23 | 0.90 | 1.15 |
| mock_tilt0.00_snr0.25_seed1_features_downweight | features_downweight | 3602 | 3139 | 1,014,000 | 193 | 226595.4 \(\pm\) 0.25 | 0.35 | 1.14 |
| mock_tilt0.00_snr0.25_seed2_all | all | 3602 | 3038 | 1,105,000 | 150 | 231920.0 \(\pm\) 0.31 | 0.91 | 0.57 |
| mock_tilt0.00_snr0.25_seed2_features | features | 1389 | 2970 | 1,020,500 | 186 | 89693.6 \(\pm\) 0.23 | 0.92 | 0.62 |
| mock_tilt0.00_snr0.25_seed2_features_downweight | features_downweight | 3602 | 3105 | 1,040,000 | 139 | 226583.8 \(\pm\) 0.22 | 0.36 | 0.61 |
| mock_tilt0.00_snr1.00_seed1_all | all | 3602 | 3176 | 1,365,000 | 217 | 236513.8 \(\pm\) 0.40 | 0.50 | 1.00 |
| mock_tilt0.00_snr1.00_seed1_features | features | 1389 | 3157 | 1,261,000 | 195 | 91449.3 \(\pm\) 0.20 | 0.53 | 1.03 |
| mock_tilt0.00_snr1.00_seed1_features_downweight | features_downweight | 3602 | 3097 | 1,306,500 | 208 | 228314.3 \(\pm\) 0.28 | 0.20 | 1.02 |
| mock_tilt0.00_snr1.00_seed2_all | all | 3602 | 3220 | 1,378,000 | 184 | 236464.7 \(\pm\) 0.31 | 0.52 | 1.29 |
| mock_tilt0.00_snr1.00_seed2_features | features | 1389 | 3254 | 1,241,500 | 166 | 91451.9 \(\pm\) 0.31 | 0.52 | 1.26 |
| mock_tilt0.00_snr1.00_seed2_features_downweight | features_downweight | 3602 | 3190 | 1,306,500 | 176 | 228418.7 \(\pm\) 0.32 | 0.20 | 1.24 |
| mock_tilt0.03_snr0.25_seed1_all | all | 3602 | 3099 | 1,118,000 | 227 | 231882.3 \(\pm\) 0.20 | 0.93 | 2.03 |
| mock_tilt0.03_snr0.25_seed1_features | features | 1389 | 3459 | 1,046,500 | 204 | 89672.5 \(\pm\) 0.17 | 0.94 | 1.87 |
| mock_tilt0.03_snr0.25_seed1_features_downweight | features_downweight | 3602 | 3388 | 1,066,000 | 148 | 226546.4 \(\pm\) 0.24 | 0.36 | 1.84 |
| mock_tilt0.03_snr0.25_seed2_all | all | 3602 | 3331 | 1,144,000 | 227 | 231815.0 \(\pm\) 0.41 | 0.96 | 2.04 |
| mock_tilt0.03_snr0.25_seed2_features | features | 1389 | 3346 | 1,066,000 | 206 | 89657.2 \(\pm\) 0.31 | 0.95 | 1.42 |
| mock_tilt0.03_snr0.25_seed2_features_downweight | features_downweight | 3602 | 3539 | 1,066,000 | 148 | 226582.0 \(\pm\) 0.21 | 0.37 | 1.47 |
| mock_tilt0.03_snr1.00_seed1_all | all | 3602 | 3488 | 1,417,000 | 199 | 236461.4 \(\pm\) 0.31 | 0.52 | 2.84 |
| mock_tilt0.03_snr1.00_seed1_features | features | 1389 | 3532 | 1,339,000 | 186 | 91461.1 \(\pm\) 0.29 | 0.50 | 2.76 |
| mock_tilt0.03_snr1.00_seed1_features_downweight | features_downweight | 3602 | 3583 | 1,339,000 | 186 | 228377.9 \(\pm\) 0.23 | 0.19 | 2.72 |
| mock_tilt0.03_snr1.00_seed2_all | all | 3602 | 3578 | 1,423,500 | 234 | 236510.4 \(\pm\) 0.35 | 0.50 | 1.04 |
| mock_tilt0.03_snr1.00_seed2_features | features | 1389 | 3486 | 1,287,000 | 216 | 91465.2 \(\pm\) 0.23 | 0.51 | 1.00 |
| mock_tilt0.03_snr1.00_seed2_features_downweight | features_downweight | 3602 | 3389 | 1,319,500 | 217 | 228374.1 \(\pm\) 0.28 | 0.20 | 0.98 |
| mock_tilt0.06_snr0.25_seed1_all | all | 3602 | 3886 | 1,202,500 | 171 | 231856.5 \(\pm\) 0.22 | 0.92 | 7.49 |
| mock_tilt0.06_snr0.25_seed1_features | features | 1389 | 3915 | 1,144,000 | 158 | 89660.2 \(\pm\) 0.13 | 0.91 | 6.30 |
| mock_tilt0.06_snr0.25_seed1_features_downweight | features_downweight | 3602 | 3515 | 1,118,000 | 158 | 226524.6 \(\pm\) 0.30 | 0.35 | 6.27 |
| mock_tilt0.06_snr0.25_seed2_all | all | 3602 | 3298 | 1,150,500 | 225 | 231834.2 \(\pm\) 0.18 | 0.94 | 4.89 |
| mock_tilt0.06_snr0.25_seed2_features | features | 1389 | 3628 | 1,085,500 | 211 | 89656.2 \(\pm\) 0.35 | 0.94 | 3.92 |
| mock_tilt0.06_snr0.25_seed2_features_downweight | features_downweight | 3602 | 3524 | 1,098,500 | 218 | 226530.8 \(\pm\) 0.30 | 0.36 | 3.96 |
| mock_tilt0.06_snr1.00_seed1_all | all | 3602 | 3380 | 1,508,000 | 214 | 236415.4 \(\pm\) 0.33 | 0.53 | 7.67 |
| mock_tilt0.06_snr1.00_seed1_features | features | 1389 | 3828 | 1,345,500 | 196 | 91406.8 \(\pm\) 0.30 | 0.54 | 7.54 |
| mock_tilt0.06_snr1.00_seed1_features_downweight | features_downweight | 3602 | 3390 | 1,358,500 | 193 | 228312.4 \(\pm\) 0.28 | 0.21 | 7.55 |
| mock_tilt0.06_snr1.00_seed2_all | all | 3602 | 3597 | 1,449,500 | 205 | 236426.7 \(\pm\) 0.36 | 0.53 | 5.32 |
| mock_tilt0.06_snr1.00_seed2_features | features | 1389 | 3315 | 1,319,500 | 189 | 91439.8 \(\pm\) 0.42 | 0.52 | 5.09 |
| mock_tilt0.06_snr1.00_seed2_features_downweight | features_downweight | 3602 | 3453 | 1,384,500 | 196 | 228292.4 \(\pm\) 0.19 | 0.20 | 5.31 |
| real_M11_214430_all | all | 3810 | 4010 | 1,384,500 | 216 | 251147.9 \(\pm\) 0.27 | 1.17 | 17.44 |
| real_M11_214430_features | features | 1088 | 3339 | 1,189,500 | 234 | 71696.5 \(\pm\) 0.20 | 1.06 | 7.87 |
| real_M11_214430_features_downweight | features_downweight | 3810 | 3578 | 1,202,500 | 189 | 246488.0 \(\pm\) 0.15 | 0.32 | 7.96 |
| real_M5_172669_all | all | 3602 | 3070 | 1,176,500 | 157 | 232731.2 \(\pm\) 0.33 | 1.06 | 14.12 |
| real_M5_172669_features | features | 1389 | 3254 | 1,170,000 | 156 | 90430.5 \(\pm\) 0.32 | 1.03 | 12.22 |
| real_M5_172669_features_downweight | features_downweight | 3602 | 3208 | 1,209,000 | 161 | 227369.5 \(\pm\) 0.36 | 0.40 | 12.33 |
| real_M9_232005_all | all | 3494 | 3497 | 1,202,500 | 160 | 230695.7 \(\pm\) 0.26 | 1.11 | 7.34 |
| real_M9_232005_features | features | 1521 | 3811 | 1,170,000 | 175 | 100541.2 \(\pm\) 0.25 | 1.13 | 6.98 |
| real_M9_232005_features_downweight | features_downweight | 3494 | 3636 | 1,170,000 | 165 | 226195.2 \(\pm\) 0.29 | 0.50 | 7.01 |

<details>
<summary>Mock recovery</summary>

Truth: the weighted posterior median of the stored full-spectrum fit of M5_172669. Each cell is two noise realisations; bias is the mean of (posterior median − truth), the width column is the 16–84 half-width relative to the full-spectrum fit of the same cell, and coverage counts the realisations of that \(\mathrm{S/N}\) scale (three tilts, two seeds) whose 16–84 interval contains the truth.

</details>

| parameter | mode | bias, \(\epsilon\)=0.00 | bias, \(\epsilon\)=0.03 | bias, \(\epsilon\)=0.06 | width / full, median (range) | 68% coverage |
| --- | --- | --- | --- | --- | --- | --- |
| \(\log M_\star\) | full spectrum | +0.005 | +0.051 | +0.077 | 1.00 (1.00–1.00) | 1/6 |
| \(\log M_\star\) | features only | +0.004 | +0.049 | +0.078 | 1.23 (0.92–2.15) | 0/6 |
| \(\log M_\star\) | continuum down-weighted | +0.006 | +0.050 | +0.074 | 1.18 (1.08–1.73) | 1/6 |
...
| \(\tau_{\mathrm{dust}}\) | full spectrum | -0.001 | +0.106 | +0.212 | 1.00 (1.00–1.00) | 2/6 |
| \(\tau_{\mathrm{dust}}\) | features only | +0.000 | +0.099 | +0.199 | 1.60 (1.12–2.05) | 2/6 |
| \(\tau_{\mathrm{dust}}\) | continuum down-weighted | +0.001 | +0.098 | +0.201 | 1.39 (0.78–1.93) | 2/6 |

| parameter | mode | bias, \(\epsilon\)=0.00 | bias, \(\epsilon\)=0.03 | bias, \(\epsilon\)=0.06 | width / full, median (range) | 68% coverage |
| --- | --- | --- | --- | --- | --- | --- |
| \(\log M_\star\) | full spectrum | +0.005 | +0.048 | +0.078 | 1.00 (1.00–1.00) | 2/6 |
| \(\log M_\star\) | features only | +0.008 | +0.040 | +0.079 | 1.01 (0.48–1.40) | 1/6 |
| \(\log M_\star\) | continuum down-weighted | +0.008 | +0.044 | +0.077 | 1.20 (0.64–1.58) | 1/6 |
...
| \(\tau_{\mathrm{dust}}\) | full spectrum | -0.002 | +0.097 | +0.198 | 1.00 (1.00–1.00) | 2/6 |
| \(\tau_{\mathrm{dust}}\) | features only | +0.004 | +0.080 | +0.165 | 1.56 (1.25–1.96) | 2/6 |
| \(\tau_{\mathrm{dust}}\) | continuum down-weighted | +0.004 | +0.080 | +0.164 | 1.55 (1.15–1.81) | 2/6 |
...
<figcaption>Posterior median and 16–84 interval relative to the truth against the tilt amplitude \(\epsilon\), for the native pixel \(\mathrm{S/N}\) (left) and the noise inflated four times (right).</figcaption>
<details>
<summary>Details</summary>
...
| tilt | \(\mathrm{S/N}\) scale | mode | n | bias | width | width / full | RMS z | cov68 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
Shift of the masked-mode posterior median from the full-spectrum median, in units of the full-spectrum 16–84 half-width. Feature pixels kept by the 1000 \(\mathrm{km\,s^{-1}}\) windows: M11_214430: 1088 of 3810 pixels (29%); M5_172669: 1389 of 3602 pixels (39%); M9_232005: 1521 of 3494 pixels (44%).
