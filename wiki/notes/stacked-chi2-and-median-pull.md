...
Grey windows on the two rest-frame panels are the nine major absorption features at z = 0, named below each panel (`scripts/spectral_figures.py`). The histogram carries no wavelength axis, so it stays bare.
