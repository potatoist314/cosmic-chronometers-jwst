...
| --- | --- | --- |
| **187-Galaxy DR2 Sample** | Median mass-weighted age 3.02 Gyr. Median assembly interval \(\Delta t\) = 2.46 Gyr. Zero fit failures among 187 galaxies. | [Analysis Page](../dr2-quiescent-sample/) · [Summary CSV](/wiki/f/results/dr2-quiescent-summary.csv) · [Results Dir](/wiki/f/archive/results/dr2-quiescent-no-polynomial) |
...
Analysis page: [analyses/dr2-quiescent-sample.html](../dr2-quiescent-sample/). Master catalogue table: [archive/results/dr2-quiescent-no-polynomial/dr2-quiescent-summary.csv](/wiki/f/results/dr2-quiescent-summary.csv) (187 galaxies, 49 columns including \(t_{20}\), \(t_{50}\), \(t_{80}\), \(\Delta t\)). Production run directory: [archive/results/dr2-quiescent-no-polynomial/](/wiki/f/archive/results/dr2-quiescent-no-polynomial) (187 individual target folders). Exploratory chronometer notebook: [ceridwen_cosmic_chronometer.ipynb](/wiki/f/archive/results/dr2-quiescent-no-polynomial/ceridwen_cosmic_chronometer.ipynb) and summary data: [ceridwen_cosmic_chronometer_summary.h5](/wiki/f/archive/results/dr2-quiescent-no-polynomial/ceridwen_cosmic_chronometer_summary.h5). Builders: [build_dr2_quiescent_summary.py](/wiki/f/scripts/build_dr2_quiescent_summary.py), [plot_dr2_headline_candidates.py](/wiki/f/archive/scripts/plot_dr2_headline_candidates.py).
...
| `dr2-production-results-dir` | **DR2 187-galaxy production result directory** | result-directory | `inode/directory` | [../../archive/results/dr2-quiescent-no-polynomial](/wiki/f/archive/results/dr2-quiescent-no-polynomial) |
| `chronometer-notebook` | **Ceridwen cosmic-chronometer notebook** | notebook | `application/x-ipynb+json` | [../../archive/results/dr2-quiescent-no-polynomial/ceridwen_cosmic_chronometer.ipynb](/wiki/f/archive/results/dr2-quiescent-no-polynomial/ceridwen_cosmic_chronometer.ipynb) |
| `chronometer-summary-h5` | **Ceridwen chronometer summary data** | data-summary | `application/x-hdf5` | [../../archive/results/dr2-quiescent-no-polynomial/ceridwen_cosmic_chronometer_summary.h5](/wiki/f/archive/results/dr2-quiescent-no-polynomial/ceridwen_cosmic_chronometer_summary.h5) |
