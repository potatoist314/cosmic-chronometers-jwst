...
kind: experiment
id: e-dr2-baseline
title: Baseline DR2 population fit
date: 2026-09-03
origin: existing
status: recorded
...
The first full-spectrum campaign fits the 187 selected DR2 galaxies. Its saved notebook uses aperture photometry and no calibration polynomial.
...
[
  {
    ...
    "view": "Comparison",
    "caption": "Baseline sample: parameter distributions for all 187 targets; ages are mass-weighted; metallicity is \\([\\mathrm{Fe}/\\mathrm{H}]\\).",
    "target": ""
  },
  {
