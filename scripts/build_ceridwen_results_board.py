...
<body>
  ...
  <main class="page-shell" id="main-content">
    ...
    <section id="dr2-sample">
      ...
      <p>Analysis page: <a href="{items_by_id['dr2-analysis-page']['wiki_relative_path']}">analyses/dr2-quiescent-sample.html</a>. Master catalogue table: <a href="{items_by_id['dr2-summary-csv']['wiki_relative_path']}">results/dr2-quiescent-new-defaults-summary.csv</a> (187 galaxies, 49 columns including t20, t50, t80, &Delta;t). Production run directory: <a href="{items_by_id['dr2-production-results-dir']['wiki_relative_path']}">results/dr2-quiescent-new-defaults/</a> (187 individual target folders). Exploratory chronometer notebook: <a href="{items_by_id['chronometer-notebook']['wiki_relative_path']}">ceridwen_cosmic_chronometer.ipynb</a> and summary data: <a href="{items_by_id['chronometer-summary-h5']['wiki_relative_path']}">ceridwen_cosmic_chronometer_summary.h5</a>. Builders: <a href="{items_by_id['dr2-summary-builder']['wiki_relative_path']}">build_dr2_quiescent_summary.py</a>, <a href="{items_by_id['dr2-headline-script']['wiki_relative_path']}">plot_dr2_headline_candidates.py</a>.</p>
